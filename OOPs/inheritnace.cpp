...
//     string Motherboard = "Motherboard is available";

//     void display()
//     {
//         cout << "parent functions got called and the common data members are," << endl;
...
// AsusSub(string Storage_type, string Ram_version) : Asus(Storage_type, Ram_version){}

// Anand Suthar
// 10:44
// class LanovoSubBrand : public Lenovo
// {

// public:
//     LanovoSubBrand() : Lenovo("Default SSD", "8GB") {}
//     void display2()
//     {
//         cout << "This function is declared inside LenovoSubBrand who is a children class of its Lenovo parent only" << endl;
