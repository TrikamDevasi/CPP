 ...
 * 
 * This function is the entry point of the program. It creates objects of
 * parent1 and child1 classes and calls their show() member functions.
 * 
 * @return int Return code of the program (0 if successful)
 */
